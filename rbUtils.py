...
def setGoals(rlist, goalList=defaultGoalList):
    for rob in rlist:
...
def randomStep(rlist, xlo=0, xhi=1, ylo=0, yhi=1):
    for rob in rlist:
        moveRandom(rob)
...
def resourceCollector(rlist, xlo=0, xhi=1, ylo=0, yhi=1):
    for rob in rlist:
...
def disperse(rlist, xlo=0, xhi=1, ylo=0, yhi=1):
    for rob in rlist:
...
def static(rlist, xlo=0, xhi=1, ylo=0, yhi=1):
    pass
